...
import 'package:video_player/src/facebook_utils.dart';
import 'package:video_player/src/youtube_util.dart';
  ...
  Future<void> initialize() async {
    ...
    switch (dataSourceType) {
      ...
      case DataSourceType.network:
        String finalUrl = dataSource;
        if (YoutubeUtils.isYoutubeLink(dataSource)) {
          finalUrl = await YoutubeUtils.generateDownloadVideoUrl(dataSource) ??
              dataSource;
        } else if (FacebookUtils.isFacebookUrl(dataSource)) {
          finalUrl = await FacebookUtils.generateDownloadVideoUrl(dataSource) ??
              dataSource;
        }
        dataSourceDescription = DataSource(
